      ...
      <Collapse isOpen={open}>
        <CardBody>
          <Row>
            ...
            {/* ShowLabelNumber */}
            <Col xs="12" sm="6" md="3" className="mb-1">
              <Label for="ShowLabelNumber" className="form-label">
                فرمت نمایش
              </Label>
              <div className="position-relative d-flex align-items-center">
                <Input
                  ...
                  id="ShowLabelNumber"
                  type="number"
                  value={filters.ShowLabelNumber}
                  onChange={(e) =>
                    setFilters({ ...filters, ShowLabelNumber: e.target.value })
                  }
                />
                {filters?.ShowLabelNumber?.length > 0 ? (
                  <IoClose
                    onClick={() =>
                      setFilters({ ...filters, ShowLabelNumber: "" })
                    }
                    style={{
                      cursor: "pointer",
                      position: "absolute",
          ...
          <Col sm="12" className="mt-2 d-flex justify-content-end">
            <CustomButton
              onClick={() => {
                ...
                getSimcardNumbers(1, perPage, "without_filter");
              }}
              color="danger"
            >
              پاک کردن فیلتر ها
