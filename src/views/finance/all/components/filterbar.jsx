          ...
          <Row>
            ...
            <Col xs="12" sm="6" md="3" className="mb-1">
              ...
              <AsyncPaginate
                ...
                onChange={(value) => setFilters({ ...filters, GradeId: value })}
                additional={{
                  page: 1,
                }}
            ...
            <Col xs="12" sm="6" md="3" className="mb-1">
              ...
              <AsyncPaginate
                ...
                loadOptions={getFilterSelectProduct}
                onChange={(value) =>
                ...
                closeMenuOnSelect={true}
                theme={selectThemeColors}
                isDisabled={!filters.OperatorId}
                cacheUniqs={[filters.OperatorId]}
                isClearable={true}
            ...
            <Col xs="12" sm="6" md="3" className="mb-1">
              ...
              <AsyncPaginate
                ...
                loadOptions={getFilterSelectService}
                onChange={(value) =>
